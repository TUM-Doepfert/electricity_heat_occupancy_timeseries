...
OBJECTS = \
	...
	".\cg_model_2016.obj" \
	".\cg_model_2016_init.obj" \
	".\cg_model_2016_functions.obj" \
	".\cg_model_2016_decl.obj" \
	".\cg_model_2016_initjac.obj" \
	".\cg_model_2016_jac.obj"
...
all : check_option model_2016.dll clean

check_option :
	@$(OPTION_UNDEFINED)

model_2016.dll : $(OBJECTS_WITH_PATH)
	link /dll /nologo /FORCE /INCREMENTAL:NO /OPT:NOREF $(LDFLAGS) $(LDLIBS) $(OMPLIBS) /OUT:"model_2016.dll" $(OBJECTS)
...
clean:
	...
	$(RM) ".\sundials_serialization.obj" ".\sundials_smalldense.obj" ".\cg_model_2016.obj" ".\cg_model_2016_init.obj" 
	$(RM) ".\cg_model_2016_functions.obj" ".\cg_model_2016_decl.obj" ".\cg_model_2016_initjac.obj" ".\cg_model_2016_jac.obj" 
...
help :
	@echo "usage: nmake /f model_2016.mak all"
