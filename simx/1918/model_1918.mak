...
OBJECTS = \
	...
	".\cg_model_1918.obj" \
	".\cg_model_1918_init.obj" \
	".\cg_model_1918_functions.obj" \
	".\cg_model_1918_decl.obj" \
	".\cg_model_1918_initjac.obj" \
	".\cg_model_1918_jac.obj"
...
all : check_option model_1918.dll clean

check_option :
	@$(OPTION_UNDEFINED)

model_1918.dll : $(OBJECTS_WITH_PATH)
	link /dll /nologo /FORCE /INCREMENTAL:NO /OPT:NOREF $(LDFLAGS) $(LDLIBS) $(OMPLIBS) /OUT:"model_1918.dll" $(OBJECTS)
...
clean:
	...
	$(RM) ".\sundials_serialization.obj" ".\sundials_smalldense.obj" ".\cg_model_1918.obj" ".\cg_model_1918_init.obj" 
	$(RM) ".\cg_model_1918_functions.obj" ".\cg_model_1918_decl.obj" ".\cg_model_1918_initjac.obj" ".\cg_model_1918_jac.obj" 
...
help :
	@echo "usage: nmake /f model_1918.mak all"
