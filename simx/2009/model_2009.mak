...
OBJECTS = \
	...
	".\cg_model_2009.obj" \
	".\cg_model_2009_init.obj" \
	".\cg_model_2009_functions.obj" \
	".\cg_model_2009_decl.obj" \
	".\cg_model_2009_initjac.obj" \
	".\cg_model_2009_jac.obj"
...
all : check_option model_2009.dll clean

check_option :
	@$(OPTION_UNDEFINED)

model_2009.dll : $(OBJECTS_WITH_PATH)
	link /dll /nologo /FORCE /INCREMENTAL:NO /OPT:NOREF $(LDFLAGS) $(LDLIBS) $(OMPLIBS) /OUT:"model_2009.dll" $(OBJECTS)
...
clean:
	...
	$(RM) ".\sundials_serialization.obj" ".\sundials_smalldense.obj" ".\cg_model_2009.obj" ".\cg_model_2009_init.obj" 
	$(RM) ".\cg_model_2009_functions.obj" ".\cg_model_2009_decl.obj" ".\cg_model_2009_initjac.obj" ".\cg_model_2009_jac.obj" 
...
help :
	@echo "usage: nmake /f model_2009.mak all"
