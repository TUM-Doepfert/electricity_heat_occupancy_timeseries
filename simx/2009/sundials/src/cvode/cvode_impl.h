...
typedef struct CVodeMemRec {
  ...
  int cv_maxStepNumberBetweenJacobianEvaluations; /*maximum number of steps between Jacobian evaluations*/
  ...
  CVTraceFn cv_tfun;            /* Tracing is handled by tfun  */
  void *cv_tf_data;             /* user pointer passed to tfun */
  /* trace flags */
  booleantype trRes;
  booleantype trStates;
  booleantype trDer;
  booleantype trNewtonUpdate;
  booleantype trJac;
  booleantype trStepTrue;
  booleantype trResTrue;
  booleantype trStatesTrue;
  booleantype trDerTrue;
  booleantype trStepFalse;
  booleantype trResFalse;
  booleantype trStatesFalse;
  booleantype trDerFalse;
  booleantype trNewtonUpdateFalse;
  /* history during corrector iteration of ... */
  realtype *cv_states;          /* states */
  realtype *cv_derivatives;     /* derivatives */
  realtype *cv_residuals;       /* residuals */
  realtype *cv_corrections;     /* Newton updates */
  long int cv_dim;				/* problem size */
  char **cv_stateNames;			/* array of names of the states */
  char **cv_dstateNames;		/* array of names of the derivatives */
  int cv_trwidth;				/* max. width of state names */
  int cv_dtrwidth;				/* max. width of derivative names */
  booleantype cv_trMallocDone;

  /*-------------
    Serialization
    -------------*/

  CVSerializationFn     cv_LinSolvSerialization;
  CVSerializationFn     cv_LinSolvDeserialization;
  CVSerializationSizeFn cv_LinSolvSerializationSize;
  CVSerializationFn     cv_UserSerialization;
  CVSerializationFn     cv_UserDeserialization;
  CVSerializationSizeFn cv_UserSerializationSize;
  void *cv_UserSerializationData;
