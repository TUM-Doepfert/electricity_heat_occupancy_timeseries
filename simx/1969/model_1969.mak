...
OBJECTS = \
	...
	".\cg_model_1969.obj" \
	".\cg_model_1969_init.obj" \
	".\cg_model_1969_functions.obj" \
	".\cg_model_1969_decl.obj" \
	".\cg_model_1969_initjac.obj" \
	".\cg_model_1969_jac.obj"
...
all : check_option model_1969.dll clean

check_option :
	@$(OPTION_UNDEFINED)

model_1969.dll : $(OBJECTS_WITH_PATH)
	link /dll /nologo /FORCE /INCREMENTAL:NO /OPT:NOREF $(LDFLAGS) $(LDLIBS) $(OMPLIBS) /OUT:"model_1969.dll" $(OBJECTS)
...
clean:
	...
	$(RM) ".\sundials_serialization.obj" ".\sundials_smalldense.obj" ".\cg_model_1969.obj" ".\cg_model_1969_init.obj" 
	$(RM) ".\cg_model_1969_functions.obj" ".\cg_model_1969_decl.obj" ".\cg_model_1969_initjac.obj" ".\cg_model_1969_jac.obj" 
...
help :
	@echo "usage: nmake /f model_1969.mak all"
