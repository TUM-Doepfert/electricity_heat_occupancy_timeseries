...
OBJECTS = \
	...
	".\cg_model_1984.obj" \
	".\cg_model_1984_init.obj" \
	".\cg_model_1984_functions.obj" \
	".\cg_model_1984_decl.obj" \
	".\cg_model_1984_initjac.obj" \
	".\cg_model_1984_jac.obj"
...
all : check_option model_1984.dll clean

check_option :
	@$(OPTION_UNDEFINED)

model_1984.dll : $(OBJECTS_WITH_PATH)
	link /dll /nologo /FORCE /INCREMENTAL:NO /OPT:NOREF $(LDFLAGS) $(LDLIBS) $(OMPLIBS) /OUT:"model_1984.dll" $(OBJECTS)
...
clean:
	...
	$(RM) ".\sundials_serialization.obj" ".\sundials_smalldense.obj" ".\cg_model_1984.obj" ".\cg_model_1984_init.obj" 
	$(RM) ".\cg_model_1984_functions.obj" ".\cg_model_1984_decl.obj" ".\cg_model_1984_initjac.obj" ".\cg_model_1984_jac.obj" 
...
help :
	@echo "usage: nmake /f model_1984.mak all"
