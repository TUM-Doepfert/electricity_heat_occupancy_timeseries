...
OBJECTS = \
	...
	".\cg_model_2002.obj" \
	".\cg_model_2002_init.obj" \
	".\cg_model_2002_functions.obj" \
	".\cg_model_2002_decl.obj" \
	".\cg_model_2002_initjac.obj" \
	".\cg_model_2002_jac.obj"
...
all : check_option model_2002.dll clean

check_option :
	@$(OPTION_UNDEFINED)

model_2002.dll : $(OBJECTS_WITH_PATH)
	link /dll /nologo /FORCE /INCREMENTAL:NO /OPT:NOREF $(LDFLAGS) $(LDLIBS) $(OMPLIBS) /OUT:"model_2002.dll" $(OBJECTS)
...
clean:
	...
	$(RM) ".\sundials_serialization.obj" ".\sundials_smalldense.obj" ".\cg_model_2002.obj" ".\cg_model_2002_init.obj" 
	$(RM) ".\cg_model_2002_functions.obj" ".\cg_model_2002_decl.obj" ".\cg_model_2002_initjac.obj" ".\cg_model_2002_jac.obj" 
...
help :
	@echo "usage: nmake /f model_2002.mak all"
