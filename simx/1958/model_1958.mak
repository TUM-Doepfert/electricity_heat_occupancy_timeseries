...
OBJECTS = \
	...
	".\cg_model_1958.obj" \
	".\cg_model_1958_init.obj" \
	".\cg_model_1958_functions.obj" \
	".\cg_model_1958_decl.obj" \
	".\cg_model_1958_initjac.obj" \
	".\cg_model_1958_jac.obj"
...
all : check_option model_1958.dll clean

check_option :
	@$(OPTION_UNDEFINED)

model_1958.dll : $(OBJECTS_WITH_PATH)
	link /dll /nologo /FORCE /INCREMENTAL:NO /OPT:NOREF $(LDFLAGS) $(LDLIBS) $(OMPLIBS) /OUT:"model_1958.dll" $(OBJECTS)
...
clean:
	...
	$(RM) ".\sundials_serialization.obj" ".\sundials_smalldense.obj" ".\cg_model_1958.obj" ".\cg_model_1958_init.obj" 
	$(RM) ".\cg_model_1958_functions.obj" ".\cg_model_1958_decl.obj" ".\cg_model_1958_initjac.obj" ".\cg_model_1958_jac.obj" 
...
help :
	@echo "usage: nmake /f model_1958.mak all"
