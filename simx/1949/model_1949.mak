...
OBJECTS = \
	...
	".\cg_model_1949.obj" \
	".\cg_model_1949_init.obj" \
	".\cg_model_1949_functions.obj" \
	".\cg_model_1949_decl.obj" \
	".\cg_model_1949_initjac.obj" \
	".\cg_model_1949_jac.obj"
...
all : check_option model_1949.dll clean

check_option :
	@$(OPTION_UNDEFINED)

model_1949.dll : $(OBJECTS_WITH_PATH)
	link /dll /nologo /FORCE /INCREMENTAL:NO /OPT:NOREF $(LDFLAGS) $(LDLIBS) $(OMPLIBS) /OUT:"model_1949.dll" $(OBJECTS)
...
clean:
	...
	$(RM) ".\sundials_serialization.obj" ".\sundials_smalldense.obj" ".\cg_model_1949.obj" ".\cg_model_1949_init.obj" 
	$(RM) ".\cg_model_1949_functions.obj" ".\cg_model_1949_decl.obj" ".\cg_model_1949_initjac.obj" ".\cg_model_1949_jac.obj" 
...
help :
	@echo "usage: nmake /f model_1949.mak all"
