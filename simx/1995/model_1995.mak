...
OBJECTS = \
	...
	".\cg_model_1995.obj" \
	".\cg_model_1995_init.obj" \
	".\cg_model_1995_functions.obj" \
	".\cg_model_1995_decl.obj" \
	".\cg_model_1995_initjac.obj" \
	".\cg_model_1995_jac.obj"
...
all : check_option model_1995.dll clean

check_option :
	@$(OPTION_UNDEFINED)

model_1995.dll : $(OBJECTS_WITH_PATH)
	link /dll /nologo /FORCE /INCREMENTAL:NO /OPT:NOREF $(LDFLAGS) $(LDLIBS) $(OMPLIBS) /OUT:"model_1995.dll" $(OBJECTS)
...
clean:
	...
	$(RM) ".\sundials_serialization.obj" ".\sundials_smalldense.obj" ".\cg_model_1995.obj" ".\cg_model_1995_init.obj" 
	$(RM) ".\cg_model_1995_functions.obj" ".\cg_model_1995_decl.obj" ".\cg_model_1995_initjac.obj" ".\cg_model_1995_jac.obj" 
...
help :
	@echo "usage: nmake /f model_1995.mak all"
