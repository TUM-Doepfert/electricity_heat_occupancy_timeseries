...
OBJECTS = \
	...
	".\cg_model_1979.obj" \
	".\cg_model_1979_init.obj" \
	".\cg_model_1979_functions.obj" \
	".\cg_model_1979_decl.obj" \
	".\cg_model_1979_initjac.obj" \
	".\cg_model_1979_jac.obj"
...
all : check_option model_1979.dll clean

check_option :
	@$(OPTION_UNDEFINED)

model_1979.dll : $(OBJECTS_WITH_PATH)
	link /dll /nologo /FORCE /INCREMENTAL:NO /OPT:NOREF $(LDFLAGS) $(LDLIBS) $(OMPLIBS) /OUT:"model_1979.dll" $(OBJECTS)
...
clean:
	...
	$(RM) ".\sundials_serialization.obj" ".\sundials_smalldense.obj" ".\cg_model_1979.obj" ".\cg_model_1979_init.obj" 
	$(RM) ".\cg_model_1979_functions.obj" ".\cg_model_1979_decl.obj" ".\cg_model_1979_initjac.obj" ".\cg_model_1979_jac.obj" 
...
help :
	@echo "usage: nmake /f model_1979.mak all"
